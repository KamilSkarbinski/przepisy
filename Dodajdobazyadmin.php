...
<section class="sekcja1">
    ...
    <form method="POST" action="Dodajdobazyadmin.php">
        <table id="tabela1">
            <tr>
            ...
            <tr>
                <td><textarea  cols="50" rows="2" name="wart_odz"  placeholder="Wartości odżywcze"></textarea></td>
            </tr>
            <tr>
...
<?php
    if(isset($_POST['Dodaj_Przepis'])){
        ...
        $sq="SELECT id_przepisu from `przepisy` where nazwa like $nazwa";
